...
<html lang="zh-cn">
    ...
    <body class="pd-top5">
        <div id="wrapper" class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><(ucfirst($smarty.get.app))>用户组管理</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <a href="/base/user/group/add?app=<($smarty.get.app)>" class="btn btn-success add_group">添加用户组</a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <(/foreach)>
                                            <td class="center">
                                                <a class="btn btn-primary btn-xs" href="/base/user/group/edit?app=<($smarty.get.app)>&user_group_id=<($row._id)>" >编辑</a>
