...
(function() {
  define('mis', ['jquery', 'jqueryui', 'jqueryform'], function($) {
    var func_link, mis, path_list, side_menu;
    mis = {
      ...
      path: window.location.href.split('?')[0].replace("#", ''),
      formDialog: function(tpl, settings) {
        ...
        defaultSettings = {
          ...
          dialog: {
            show: Math.floor(Math.random() * effects.length),
            hide: Math.floor(Math.random() * effects.length),
            title: '',
            width: 320,
